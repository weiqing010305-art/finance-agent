...
$("pause").addEventListener("click",async()=>{try{renderRun(await request(`/research/${state.runId}/pause`,{method:"POST"}));}catch(error){$("research-error").textContent=error.message;}});
